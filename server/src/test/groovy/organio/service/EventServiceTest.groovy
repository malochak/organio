...
class EventServiceTest extends Specification {
    ...
    def bodyValidationService = Mock(BodyValidationService)
    def bindingResult = Mock(BindingResult)

    def service = new EventService(repository, bodyValidationService)
    ...
    def "should create event - body valid"() {
        ...
        1 * bodyValidationService.checkBodyAndThrowIfNotValid(bindingResult, _ as String)
        result != null
    }
    ...
    def 'should throw RecordCreationException on event creation - predefined id'() {
        ...
        0 * bodyValidationService.checkBodyAndThrowIfNotValid(bindingResult, _ as String)
